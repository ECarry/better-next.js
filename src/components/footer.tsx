      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <motion.div 
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-bold">Next.js Template</h3>
            <p className="text-muted-foreground">
              A modern, production-ready template for building web applications with Next.js 15, Tailwind CSS v4, and more.
            </p>
            <div className="flex items-center space-x-4">
              <Link href="https://github.com/username/nextjs-template" target="_blank" rel="noopener noreferrer">
