  ...
  return (
    <div className="relative overflow-hidden">
      ...
      >
        ...
        <motion.div variants={container} className="mt-32 flex w-full max-w-6xl flex-col items-center gap-12 lg:flex-row">
          ...
          <motion.div variants={item} className="w-full flex-1 overflow-hidden rounded-xl border border-white/10 bg-[#0d1117] shadow-2xl">
        ...
        {/* Stats Section */}
        <motion.div variants={container} className="mt-32 grid w-full max-w-4xl grid-cols-2 gap-8 border-y border-white/5 py-12 sm:grid-cols-4">
          {[
        ...
        {/* Testimonials */}
        <motion.div variants={container} className="mt-32 w-full max-w-5xl">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              ...
              <motion.div key={i} variants={item} className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        {/* FAQ Section */}
        <motion.div variants={container} className="mt-32 w-full max-w-3xl">
          <motion.h2 variants={item} className="mb-12 text-center text-3xl font-bold text-white">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <motion.div key={i} variants={item} className="rounded-xl border border-white/10 bg-white/5 p-6">
        ...
        {/* CTA Section */}
        <motion.div variants={container} className="my-32 flex w-full max-w-4xl flex-col items-center rounded-3xl border border-white/10 bg-gradient-to-b from-indigo-500/20 to-purple-500/20 p-12 text-center">
